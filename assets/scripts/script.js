function Stimer() {
	function t(t) {
		var e = {};
		e.year = t[0] || new Date.getFullYear,
		e.month = t[1] - 1 || 0,
		e.day = t[2] || 0,
		e.hour = t[3] - 1 || 0,
		i = new Date(e.year, e.month, e.day, e.hour),
		r = i - o,
		s = Math.floor(r / 1e3),
		a = Math.floor(s / 60),
		l = Math.floor(a / 60),
	...
	function e(t, e) {
		var n = document.querySelectorAll(t + " .sc-sec"),
		i = document.querySelectorAll(t + " .sc-min"),
		o = document.querySelectorAll(t + " .sc-hour"),
		r = document.querySelectorAll(t + " .sc-day"),
		s = setInterval(function () {
			...
			if (u.day <= 0 && u.hour <= 0 && u.min <= 0 && u.sec <= 0) {
				clearInterval(s);
				for (var p = 0; p < n.length; p++) n[p].innerHTML = "00",
				i[p].innerHTML = "00",
				o[p].innerHTML = "00",
				r[p].innerHTML = "00";
	...
	function n(t) {
		for (var e = [], n = document.querySelectorAll(t), i = 0; i < n.length; i++) {
			...
			e[i] = document.createDocumentFragment(),
			o.classList.add("sc-sec", "sc-time"),
			r.classList.add("sc-min", "sc-time"),
			s.classList.add("sc-hour", "sc-time"),
			a.classList.add("sc-day", "sc-time"),
			o.innerHTML = u.addZero(u.sec),
			r.innerHTML = u.addZero(u.min),
			s.innerHTML = u.addZero(u.hour),
			a.innerHTML = u.addZero(u.day),
			e[i].appendChild(a),
			e[i].appendChild(s),
			e[i].appendChild(r),
			e[i].appendChild(o),
...
if (function (t, e) {
	...
	function m(t, e) {
		...
		if (1 === e.nodeType) {
			...
			ye.hasData(t) && (a = ye.access(t), l = J.extend({},
			a), ye.set(e, l))
		}
	}
	function v(t, e) {
	...
	function x(t) {
		var e = K,
		n = Fe[t];
		return n || (n = b(t, e), "none" !== n && n || (Re = (Re || J("<iframe frameborder='0' width='0' height='0'/>")).appendTo(e.documentElement), e = Re[0].contentDocument, e.write(), e.close(), n = b(t, e), Re.detach()), Fe[t] = n),
		n
	}
	function w(t, e, n) {
		...
		n && ("" !== s || J.contains(t.ownerDocument, t) || (s = J.style(t, e)), _e.test(s) && Ie.test(e) && (i = a.width, o = a.minWidth, r = a.maxWidth, a.minWidth = a.maxWidth = a.width = s, s = n.width, a.width = i, a.minWidth = o, a.maxWidth = r)),
		void 0 !== s ? s + "": s
	}
	function C(t, e) {
		return {
	...
	function E(t, e, n, i, o) {
		for (var r = n === (i ? "border": "content") ? 4 : "width" === e ? 1 : 0, s = 0; 4 > r; r += 2)"margin" === n && (s += J.css(t, n + Ce[r], !0, o)),
		i ? ("content" === n && (s -= J.css(t, "padding" + Ce[r], !0, o)), "margin" !== n && (s -= J.css(t, "border" + Ce[r] + "Width", !0, o))) : (s += J.css(t, "padding" + Ce[r], !0, o), "padding" !== n && (s += J.css(t, "border" + Ce[r] + "Width", !0, o)));
		return s
	}
	function S(t, e, n) {
		var i = !0,
	...
	function $(t, e) {
		for (var n, i, o, r = [], s = 0, a = t.length; a > s; s++) i = t[s],
		i.style && (r[s] = ve.get(i, "olddisplay"), n = i.style.display, e ? (r[s] || "none" !== n || (i.style.display = ""), "" === i.style.display && Te(i) && (r[s] = ve.access(i, "olddisplay", x(i.nodeName)))) : (o = Te(i), "none" === n && o || ve.set(i, "olddisplay", o ? n: J.css(i, "display"))));
		for (s = 0; a > s; s++) i = t[s],
	...
	function L(t, e, n) {
		...
		1 === t.nodeType && ("height" in e || "width" in e) && (n.overflow = [f.overflow, f.overflowX, f.overflowY], c = J.css(t, "display"), u = "none" === c ? ve.get(t, "olddisplay") || x(t.nodeName) : c, "inline" === u && "none" === J.css(t, "float") && (f.display = "inline-block")),
		...
		if (J.isEmptyObject(d))"inline" === ("none" === c ? x(t.nodeName) : c) && (f.display = c);
		else {
			g ? "hidden" in g && (h = g.hidden) : g = ve.access(t, "fxshow", {}),
			r && (g.hidden = !h),
			h ? J(t).show() : p.done(function () {
				J(t).hide()
			}),
			p.done(function () {
				var e;
	...
	J.extend = J.fn.extend = function () {
		...
		a++), "object" == typeof s || J.isFunction(s) || (s = {}), a === l && (s = this, a--); l > a; a++) if (null != (t = arguments[a])) for (e in t) n = s[e],
		i = t[e],
		s !== i && (c && i && (J.isPlainObject(i) || (o = J.isArray(i))) ? (o ? (o = !1, r = n && J.isArray(n) ? n: []) : r = n && J.isPlainObject(n) ? n: {},
		s[e] = J.extend(c, r, i)) : void 0 !== i && (s[e] = i));
		return s
	},
	J.extend({
		...
		makeArray: function (t, e) {
			var i = e || [];
			return null != t && (n(Object(t)) ? J.merge(i, "string" == typeof t ? [t] : t) : U.call(i, t)),
			i
		},
		...
		grep: function (t, e, n) {
			for (var i, o = [], r = 0, s = t.length, a = !n; s > r; r++) i = !e(t[r], r),
			i !== a && o.push(t[r]);
			return o
		},
		map: function (t, e, i) {
		...
		proxy: function (t, e) {
			...
			J.isFunction(t) ? (i = B.call(arguments, 2), o = function () {
	...
	var oe = function (t) {
			...
			if (O && !i) {
				if (o = ye.exec(t)) if (s = o[1]) {
					if (9 === a) {
						...
						n
					} else if (e.ownerDocument && (r = e.ownerDocument.getElementById(s)) && q(e, r) && r.id === s) return n.push(r),
					n
				} else {
		...
		function y(t) {
			...
			}]; o > a; a++) if (n = C.relative[t[a].type]) u = [f(h(u), n)];
			else {
		...
		var x, w, C, T, k, E, S, $, D, N, j, A, L, H, O, P, M, W, q, R = "sizzle" + -new Date,
		F = t.document,
		I = 0,
		_ = 0,
		B = n(),
		...
		try {
			J.apply(Y = te.call(F.childNodes), F.childNodes),
		...
		A = e.setDocument = function (t) {
			...
			M = [], P = [], (w.qsa = ve.test(n.querySelectorAll)) && (o(function (t) {
				...
				t.querySelectorAll("[msallowclip^='']").length && P.push("[*^$]=" + ie + "*(?:''|\"\")"),
				t.querySelectorAll("[selected]").length || P.push("\\[" + ie + "*(?:value|" + ne + ")"),
				t.querySelectorAll(":checked").length || P.push(":checked")
			}), o(function (t) {
				var e = n.createElement("input");
				e.setAttribute("type", "hidden"),
				t.appendChild(e).setAttribute("name", "D"),
				t.querySelectorAll("[name=d]").length && P.push("name" + ie + "*[*^$|!~]?="),
				...
				w.disconnectedMatch = W.call(t, "div"),
				W.call(t, "[s!='']:x"),
				M.push("!=", ae)
			}), P = P.length && new RegExp(P.join("|")), M = M.length && new RegExp(M.join("|")), e = ve.test(H.compareDocumentPosition), q = e || ve.test(H.contains) ?
			function (t, e) {
		...
		e.attr = function (t, e) { (t.ownerDocument || t) !== L && A(t);
			var n = C.attrHandle[e.toLowerCase()],
			i = n && Z.call(C.attrHandle, e.toLowerCase()) ? n(t, e, !O) : void 0;
			...
			filter: {
				...
				CHILD: function (t, e, n, i, o) {
					...
					function (t) {
						...
						if (m) {
							...
							} else if (y && (c = (e[R] || (e[R] = {}))[t]) && c[0] === I) d = c[1];
							else for (;
							(p = ++f && p && p[g] || (d = f = 0) || h.pop()) && ((a ? p.nodeName.toLowerCase() !== v: 1 !== p.nodeType) || !++d || (y && ((p[R] || (p[R] = {}))[t] = [I, d]), p !== e)););
							return d -= o,
							d === i || d % i === 0 && d / i >= 0
						}
					}
				...
				PSEUDO: function (t, n) {
					...
					return r[R] ? r(n) : r.length > 1 ? (o = [t, t, "", n], C.setFilters.hasOwnProperty(t.toLowerCase()) ? i(function (t, e) {
						for (var i, o = r(t, n), s = o.length; s--;) i = ee.call(t, o[s]),
						t[i] = !(e[i] = o[s])
					}) : function (t) {
						return r(t, 0, o)
					}) : r
		...
		E = e.tokenize = function (t, n) {
			...
			for (a = t, l = [], c = C.preFilter; a;) { (!i || (o = ce.exec(a))) && (o && (a = a.slice(o[0].length) || a), l.push(r = [])),
				i = !1,
		...
		S = e.compile = function (t, e) {
			...
			r = U[t + " "];
			if (!r) {
				for (e || (e = E(t)), n = e.length; n--;) r = y(e[n]),
		...
		$ = e.select = function (t, e, n, i) {
			...
			if (n = n || [], 1 === p.length) {
				...
				for (o = he.needsContext.test(t) ? 0 : r.length; o--&&(s = r[o], !C.relative[a = s.type]);) if ((l = C.find[a]) && (i = l(s.matches[0].replace(we, Ce), be.test(r[0].type) && u(e.parentNode) || e))) {
					if (r.splice(o, 1), t = i.length && d(r), !t) return J.apply(n, i),
					n;
					break
				}
			}
			return (c || S(t, p))(i, e, !O, n, be.test(t) && u(e.parentNode) || e),
			n
		},
	...
	function (t, e) {
		J.fn[t] = function (n, i) {
			...
			this.length > 1 && (de[t] || J.unique(o), pe.test(t) && o.reverse()),
			this.pushStack(o)
		}
	});
	var fe = /\S+/g,
	...
	J.Callbacks = function (t) {
		t = "string" == typeof t ? he[t] || r(t) : J.extend({},
		t);
		var e, n, i, o, s, a, l = [],
		c = !t.once && [],
		u = function (r) {
		...
		p = {
			...
			remove: function () {
				return l && J.each(arguments, function (t, e) {
					for (var n;
					(n = J.inArray(e, l, n)) > -1;) l.splice(n, 1),
					i && (s >= n && s--, a >= n && a--)
				}),
				this
			},
			...
			fireWith: function (t, e) {
				return ! l || n && !c || (e = e || [], e = [t, e.slice ? e.slice() : e], i ? c.push(e) : u(e)),
				this
			},
			fire: function () {
	...
	J.extend({
		...
		ready: function (t) { (t === !0 ? --J.readyWait: J.isReady) || (J.isReady = !0, t !== !0 && --J.readyWait > 0 || (ge.resolveWith(K, [J]), J.fn.triggerHandler && (J(K).triggerHandler("ready"), J(K).off("ready"))))
		}
	}),
	J.ready.promise = function (e) {
		return ge || (ge = J.Deferred(), "complete" === K.readyState ? setTimeout(J.ready) : (K.addEventListener("DOMContentLoaded", s, !1), t.addEventListener("load", s, !1))),
		ge.promise(e)
	},
	J.ready.promise();
	...
	a.prototype = {
		...
		remove: function (t, e) {
			...
			if (void 0 === e) this.cache[r] = {};
				...
				J.isArray(e) ? i = e.concat(e.map(J.camelCase)) : (o = J.camelCase(e), e in s ? i = [e, o] : (i = o, i = i in s ? [i] : i.match(fe) || [])),
				n = i.length;
				for (; n--;) delete s[i[n]]
			}
		},
	...
	J.fn.extend({
		...
		promise: function (t, e) {
			...
			for ("string" != typeof t && (e = t, t = void 0), t = t || "fx"; s--;) n = ve.get(r[s], t + "queueHooks"),
	...
	J.event = {
		...
		add: function (t, e, n, i, o) {
			...
			}), e = (e || "").match(fe) || [""], c = e.length; c--;) a = Ne.exec(e[c]) || [],
			f = g = a[1],
			h = (a[2] || "").split(".").sort(),
			f && (p = J.event.special[f] || {},
			f = (o ? p.delegateType: p.bindType) || f, p = J.event.special[f] || {},
			u = J.extend({
				type: f,
				origType: g,
				data: i,
		...
		remove: function (t, e, n, i, o) {
			...
			if (m && (l = m.events)) {
				for (e = (e || "").match(fe) || [""], c = e.length; c--;) if (a = Ne.exec(e[c]) || [], f = g = a[1], h = (a[2] || "").split(".").sort(), f) {
					for (p = J.event.special[f] || {},
					f = (i ? p.delegateType: p.bindType) || f, d = l[f] || [], a = a[2] && new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)"), s = r = d.length; r--;) u = d[r],
					!o && g !== u.origType || n && n.guid !== u.guid || a && !a.test(u.namespace) || i && i !== u.selector && ("**" !== i || !u.selector) || (d.splice(r, 1), u.selector && d.delegateCount--, p.remove && p.remove.call(t, u));
		...
		trigger: function (e, n, i, o) {
			var r, s, a, l, c, u, p, d = [i || K],
			f = Z.call(e, "type") ? e.type: e,
			h = Z.call(e, "namespace") ? e.namespace.split(".") : [];
			if (s = a = i = i || K, 3 !== i.nodeType && 8 !== i.nodeType && !De.test(f + J.event.triggered) && (f.indexOf(".") >= 0 && (h = f.split("."), f = h.shift(), h.sort()), c = f.indexOf(":") < 0 && "on" + f, e = e[J.expando] ? e: new J.Event(f, "object" == typeof e && e), e.isTrigger = o ? 2 : 3, e.namespace = h.join("."), e.namespace_re = e.namespace ? new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = i), n = null == n ? [e] : J.makeArray(n, [e]), p = J.event.special[f] || {},
			o || !p.trigger || p.trigger.apply(i, n) !== !1)) {
				if (!o && !p.noBubble && !J.isWindow(i)) {
					for (l = p.delegateType || f, De.test(l + f) || (s = s.parentNode); s; s = s.parentNode) d.push(s),
					a = s;
					a === (i.ownerDocument || K) && d.push(a.defaultView || a.parentWindow || t)
				}
				for (r = 0;
				(s = d[r++]) && !e.isPropagationStopped();) e.type = r > 1 ? l: p.bindType || f,
				u = (ve.get(s, "events") || {})[e.type] && ve.get(s, "handle"),
				u && u.apply(s, n),
				u = c && s[c],
				u && u.apply && J.acceptData(s) && (e.result = u.apply(s, n), e.result === !1 && e.preventDefault());
				return e.type = f,
				o || e.isDefaultPrevented() || p._default && p._default.apply(d.pop(), n) !== !1 || !J.acceptData(i) || c && J.isFunction(i[f]) && !J.isWindow(i) && (a = i[c], a && (i[c] = null), J.event.triggered = f, i[f](), J.event.triggered = void 0, a && (i[c] = a)),
				e.result
			}
		},
		dispatch: function (t) {
			...
			if (a[0] = t, t.delegateTarget = this, !c.preDispatch || c.preDispatch.call(this, t) !== !1) {
				...
				(o = s[e++]) && !t.isPropagationStopped();) for (t.currentTarget = o.elem, n = 0;
		...
		mouseHooks: {
			...
			filter: function (t, e) {
				...
				return null == t.pageX && null != e.clientX && (n = t.target.ownerDocument || K, i = n.documentElement, o = n.body, t.pageX = e.clientX + (i && i.scrollLeft || o && o.scrollLeft || 0) - (i && i.clientLeft || o && o.clientLeft || 0), t.pageY = e.clientY + (i && i.scrollTop || o && o.scrollTop || 0) - (i && i.clientTop || o && o.clientTop || 0)),
		...
		fix: function (t) {
			...
			r = t,
			s = this.fixHooks[o];
			for (s || (this.fixHooks[o] = s = $e.test(o) ? this.mouseHooks: Se.test(o) ? this.keyHooks: {}), i = s.props ? this.props.concat(s.props) : this.props, t = new J.Event(r), e = i.length; e--;) n = i[e],
			t[n] = r[n];
	...
	function (t, e) {
		J.event.special[t] = {
			...
			handle: function (t) {
				...
				o = t.relatedTarget,
				r = t.handleObj;
				return (!o || o !== i && !J.contains(i, o)) && (t.type = r.origType, n = r.handler.apply(this, arguments), t.type = e),
				n
			}
		}
	}),
	...
	J.extend({
		clone: function (t, e, n) {
			...
			if (e) if (n) for (r = r || v(t), s = s || v(a), i = 0, o = r.length; o > i; i++) m(r[i], s[i]);
			else m(t, a);
			return s = v(a, "script"),
		...
		buildFragment: function (t, e, n, i) {
			for (var o, r, s, a, l, c, u = e.createDocumentFragment(), p = [], d = 0, f = t.length; f > d; d++) if (o = t[d], o || 0 === o) if ("object" === J.type(o)) J.merge(p, o.nodeType ? [o] : o);
			else if (Le.test(o)) {
	...
	J.fn.extend({
		text: function (t) {
			return me(this, function (t) {
				return void 0 === t ? J.text(this) : this.empty().each(function () { (1 === this.nodeType || 11 === this.nodeType || 9 === this.nodeType) && (this.textContent = t)
				})
			},
		...
		remove: function (t, e) {
			for (var n, i = t ? J.filter(t, this) : this, o = 0; null != (n = i[o]); o++) e || 1 !== n.nodeType || J.cleanData(v(n)),
			n.parentNode && (e && J.contains(n.ownerDocument, n) && g(v(n, "script")), n.parentNode.removeChild(n));
			return this
		},
		empty: function () {
		...
		html: function (t) {
			return me(this, function (t) {
				...
				if ("string" == typeof t && !He.test(t) && !qe[(Ae.exec(t) || ["", ""])[1].toLowerCase()]) {
					...
					try {
						for (; i > n; n++) e = this[n] || {},
						1 === e.nodeType && (J.cleanData(v(e, !1)), e.innerHTML = t);
						e = 0
					} catch(o) {}
				}
		...
		domManip: function (t, e) {
			...
			if (c && (n = J.buildFragment(t, this[0].ownerDocument, !1, this), i = n.firstChild, 1 === n.childNodes.length && (n = i), i)) {
				for (o = J.map(v(n, "script"), f), r = o.length; c > l; l++) s = n,
				l !== p && (s = J.clone(s, !0, !0), r && J.merge(o, v(s, "script"))),
				e.call(this[l], s, l);
				if (r) for (a = o[o.length - 1].ownerDocument, J.map(o, h), l = 0; r > l; l++) s = o[l],
				Pe.test(s.type || "") && !ve.access(s, "globalEval") && J.contains(a, s) && (s.src ? J._evalUrl && J._evalUrl(s.src) : J.globalEval(s.textContent.replace(We, "")))
			}
			return this
		}
	}),
	...
	function (t, e) {
		J.fn[t] = function (t) {
			for (var n, i = [], o = J(t), r = o.length - 1, s = 0; r >= s; s++) n = s === r ? this: this.clone(!0),
			J(o[s])[e](n),
			U.apply(i, n.get());
	...
	J.extend({
		...
		style: function (t, e, n, i) {
			if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
				...
				l = t.style;
				return e = J.cssProps[a] || (J.cssProps[a] = T(l, a)),
				s = J.cssHooks[e] || J.cssHooks[a],
				void 0 === n ? s && "get" in s && void 0 !== (o = s.get(t, !1, i)) ? o: l[e] : (r = typeof n, "string" === r && (o = Ve.exec(n)) && (n = (o[1] + 1) * o[2] + parseFloat(J.css(t, e)), r = "number"), null != n && n === n && ("number" !== r || J.cssNumber[a] || (n += "px"), Y.clearCloneStyle || "" !== n || 0 !== e.indexOf("background") || (l[e] = "inherit"), s && "set" in s && void 0 === (n = s.set(t, n, i)) || (l[e] = n)), void 0)
			}
		},
		css: function (t, e, n, i) {
			var o, r, s, a = J.camelCase(e);
			return e = J.cssProps[a] || (J.cssProps[a] = T(t.style, a)),
			s = J.cssHooks[e] || J.cssHooks[a],
			s && "get" in s && (o = s.get(t, !0, n)),
			void 0 === o && (o = w(t, e, i)),
			"normal" === o && e in Qe && (o = Qe[e]),
			"" === n || n ? (r = parseFloat(o), n === !0 || J.isNumeric(r) ? r || 0 : o) : o
		}
	}),
	...
	nn = {
		"*": [function (t, e) {
			...
			s = (J.cssNumber[t] || "px" !== r && +i) && Je.exec(J.css(n.elem, t)),
			a = 1,
			l = 20;
			if (s && s[3] !== r) {
				r = r || s[3],
	...
	J.speed = function (t, e, n) {
		var i = t && "object" == typeof t ? J.extend({},
		t) : {
	...
	J.fn.extend({
		...
		stop: function (t, e, n) {
			...
			this.each(function () {
				...
				else for (o in s) s[o] && s[o].stop && tn.test(o) && i(s[o]);
	...
	J.fx.tick = function () {
		var t, e = 0,
		n = J.timers;
		for (Ye = J.now(); e < n.length; e++) t = n[e],
	...
	J.extend({
		...
		removeAttr: function (t, e) {
			var n, i, o = 0,
			r = e && e.match(fe);
			if (r && 1 === t.nodeType) for (; n = r[o++];) i = J.propFix[n] || n,
	...
	J.each(J.expr.match.bool.source.match(/\w+/g), function (t, e) {
		...
		sn[e] = function (t, e, i) {
			var o, r;
			return i || (r = sn[e], sn[e] = o, o = null != n(t, e, i) ? e.toLowerCase() : null, sn[e] = r),
			o
		}
	});
	...
	J.extend({
		...
		prop: function (t, e, n) {
			...
			if (t && 3 !== s && 8 !== s && 2 !== s) return r = 1 !== s || !J.isXMLDoc(t),
	...
	J.fn.extend({
		...
		toggleClass: function (t, e) {
			var n = typeof t;
			return "boolean" == typeof e && "string" === n ? e ? this.addClass(t) : this.removeClass(t) : this.each(J.isFunction(t) ?
			function (n) {
				J(this).toggleClass(t.call(this, n, this.className, e), e)
			}: function () {
				if ("string" === n) for (var e, i = 0, o = J(this), r = t.match(fe) || []; e = r[i++];) o.hasClass(e) ? o.removeClass(e) : o.addClass(e);
	...
	J.fn.extend({
		val: function (t) {
			var e, n, i, o = this[0]; {
				if (arguments.length) return i = J.isFunction(t),
				...
				if (o) return e = J.valHooks[o.type] || J.valHooks[o.nodeName.toLowerCase()],
	...
	J.extend({
		valHooks: {
			...
			select: {
				...
				set: function (t, e) {
					for (var n, i, o = t.options, r = J.makeArray(e), s = o.length; s--;) i = o[s],
	...
	try {
		...
		fn = K.createElement("a"),
		fn.href = "",
		fn = fn.href
	}
	dn = xn.exec(fn.toLowerCase()) || [],
	J.extend({
		active: 0,
		lastModified: {},
		etag: {},
		...
		ajax: function (t, e) {
			...
			e = e || {};
			var i, o, r, s, a, l, c, u, p = J.ajaxSetup({},
			e),
			d = p.context || p,
			...
			o = p.url,
			p.hasContent || (p.data && (o = p.url += (pn.test(o) ? "&": "?") + p.data, delete p.data), p.cache === !1 && (p.url = gn.test(o) ? o.replace(gn, "$1_=" + un++) : o + (pn.test(o) ? "&": "?") + "_=" + un++)),
			p.ifModified && (J.lastModified[o] && w.setRequestHeader("If-Modified-Since", J.lastModified[o]), J.etag[o] && w.setRequestHeader("If-None-Match", J.etag[o])),
	...
	J.each(["get", "post"], function (t, e) {
		J[e] = function (t, n, i, o) {
			return J.isFunction(n) && (o = o || i, i = n, n = void 0),
			J.ajax({
				url: t,
				type: e,
				dataType: o,
	...
	J.fn.extend({
		...
		wrapInner: function (t) {
			return this.each(J.isFunction(t) ?
			function (e) {
	...
	J.ajaxTransport(function (t) {
		...
		return Y.cors || Hn && !t.crossDomain ? {
			send: function (n, i) {
				...
				e = function (t) {
					return function () {
						e && (delete An[s], e = r.onload = r.onerror = null, "abort" === t ? r.abort() : "error" === t ? i(r.status, r.statusText) : i(Ln[r.status] || r.status, r.statusText, "string" == typeof r.responseText ? {
							text: r.responseText
	...
	J.fn.load = function (t, e, n) {
		...
		var i, o, r, s = this,
		a = t.indexOf(" ");
		return a >= 0 && (i = J.trim(t.slice(a)), t = t.slice(0, a)),
		J.isFunction(e) ? (n = e, e = void 0) : e && "object" == typeof e && (o = "POST"),
		s.length > 0 && J.ajax({
			url: t,
			type: o,
			dataType: "html",
	...
	J.offset = {
		setOffset: function (t, e, n) {
			...
			c ? (i = p.position(), s = i.top, o = i.left) : (s = parseFloat(r) || 0, o = parseFloat(l) || 0),
	...
	J.fn.extend({
		offset: function (t) {
			...
			J.contains(e, i) ? (typeof i.getBoundingClientRect !== Ee && (o = i.getBoundingClientRect()), n = I(r), {
	...
	return J.noConflict = function (e) {
		return t.$ === J && (t.$ = Rn),
		e && t.jQuery === J && (t.jQuery = qn),
		J
	},
	typeof e === Ee && (t.jQuery = t.$ = J),
	J
}), function (t, e, n, i) {
	"use strict";
	var o = n("html"),
	...
	g = function (t, e) {
		...
		return e && f(t) && (n = a.getViewport()[e] / 100 * n),
		Math.ceil(n)
	},
	m = function (t, e) {
		return g(t, e) + "px"
	...
	n.extend(a, {
		...
		open: function (t, e) {
			return t && (n.isPlainObject(e) || (e = {}), !1 !== a.close(!0)) ? (n.isArray(t) || (t = p(t) ? n(t).get() : [t]), n.each(t, function (o, r) {
				...
				n.metadata && n.extend(!0, m, r.metadata())) : m = r),
				s = e.href || m.href || (d(r) ? r: null),
				l = e.title !== i ? e.title: m.title || "",
				c = e.content || m.content,
				u = c ? "html": e.type || m.type,
				!u && m.isDom && (u = r.data("fancybox-type"), u || (f = r.prop("class").match(/fancybox\.(\w+)/), u = f ? f[1] : null)),
				d(s) && (u || (a.isImage(s) ? u = "image": a.isSWF(s) ? u = "swf": "#" === s.charAt(0) ? u = "inline": d(r) && (u = "html", c = r)), "ajax" === u && (h = s.split(/\s+/, 2), s = h.shift(), g = h.shift())),
				c || ("inline" === u ? s ? c = n(d(s) ? s.replace(/.*(?=#[^\s]+$)/, "") : s) : m.isDom && (c = r) : "html" === u ? c = s: u || s || !m.isDom || (u = "inline", c = r)),
				n.extend(m, {
					href: s,
					type: u,
					content: c,
			...
			a.defaults, e), e.keys !== i && (a.opts.keys = e.keys ? n.extend({},
		...
		close: function (t) {
			a.cancel(),
			!1 !== a.trigger("beforeClose") && (a.unbindEvents(), a.isActive && (a.isOpen && t !== !0 ? (a.isOpen = a.isOpened = !1, a.isClosing = !0, n(".fancybox-item, .fancybox-nav").remove(), a.wrap.stop(!0, !0).removeClass("fancybox-opened"), a.transitions[a.current.closeMethod]()) : (n(".fancybox-wrap").stop(!0).trigger("onReset").remove(), a._afterZoomOut())))
		},
		play: function (t) {
			var e = function () {
		...
		reposition: function (t, e) {
			var i, o = a.current,
			r = o ? o.wrap: null;
			r && (i = a._getPosition(e), t && "scroll" === t.type ? (delete i.position, r.stop(!0, !0).animate(i, 200)) : (r.css(i), o.pos = n.extend({},
			o.dim, i)))
		},
		update: function (t) {
			var e = t && t.type,
		...
		showLoading: function () {
			var t, e;
			a.hideLoading(),
			t = n('<div id="fancybox-loading"><div></div></div>').click(a.cancel).appendTo("body"),
		...
		getViewport: function () {
			...
			return e ? (n.w = e[0].clientWidth, n.h = e[0].clientHeight) : (n.w = u && t.innerWidth ? t.innerWidth: r.width(), n.h = u && t.innerHeight ? t.innerHeight: r.height()),
			n
		},
		...
		bindEvents: function () {
			...
			e && (r.bind("orientationchange.fb" + (u ? "": " resize.fb") + (e.autoCenter && !e.locked ? " scroll.fb": ""), a.update), t = e.keys, t && s.bind("keydown.fb", function (o) {
				...
				for (var s = t.target || null, l = n(s), c = !1; l.length && !(c || l.is(".fancybox-skin") || l.is(".fancybox-wrap"));) c = h(l[0]),
				l = n(l).parent();
		...
		trigger: function (t, e) {
			...
			if (o) {
				...
				o.helpers && n.each(o.helpers, function (e, i) {
					i && a.helpers[e] && n.isFunction(a.helpers[e][t]) && a.helpers[e][t](n.extend(!0, {},
					a.helpers[e].defaults, i), o)
				}),
				s.trigger(t)
			}
		},
		...
		_start: function (t) {
			...
			if (l = n.extend(!0, {},
			a.opts, e), r = l.margin, s = l.padding, "number" === n.type(r) && (l.margin = [r, r, r, r]), "number" === n.type(s) && (l.padding = [s, s, s, s]), l.modal && n.extend(!0, l, {
				closeBtn: !1,
				closeClick: !1,
				nextClick: !1,
				arrows: !1,
			...
			if (o = l.type, i = l.href, !o) return a.coming = null,
		...
		_preloadImages: function () {
			...
			for (e = 1; r >= e; e += 1) t = n[(i.index + e) % o],
		...
		_afterLoad: function () {
			...
			if (a.hideLoading(), l && a.isActive !== !1) {
				...
				case "image":
					...
					break;
				case "swf":
					e = '<object id="fancybox-swf" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="100%" height="100%"><param name="movie" value="' + r + '"></param>',
					s = "",
				...
				p(e) && e.parent().is(t.inner) || t.inner.append(e),
				...
				a.coming = null,
				a.bindEvents(),
				a.isOpened ? c.prevMethod && a.transitions[c.prevMethod]() : n(".fancybox-wrap").not(t.wrap).stop(!0).trigger("onReset").remove(),
				a.transitions[a.isOpened ? t.nextMethod: t.openMethod](),
				a._preloadImages()
			}
		},
		_setDimension: function () {
			var t, e, i, o, r, s, l, c, u, p, d, h, v, y, b, x = a.getViewport(),
			w = 0,
			C = !1,
			T = !1,
			k = a.wrap,
			...
			p = k.width(),
			d = k.height();
			else D = Math.max(j, Math.min(D, D - (p - h))),
			N = Math.max(A, Math.min(N, N - (d - v)));
			P && "auto" === O && s > N && h > D + t + P && (D += P),
			S.width(D).height(N),
			k.width(D + t),
			p = k.width(),
			d = k.height(),
			C = (p > h || d > v) && D > j && N > A,
			T = $.aspectRatio ? l > D && c > N && r > D && s > N: (l > D || c > N) && (r > D || s > N),
			n.extend($, {
				dim: {
					width: m(p),
					height: m(d)
		...
		_getPosition: function (t) {
			...
			return e.autoCenter && e.fixed && !t && r <= n.h && o <= n.w ? s.position = "fixed": e.locked || (s.top += n.y, s.left += n.x),
			s.top = m(Math.max(s.top, s.top + (n.h - r) * e.topRatio)),
			s.left = m(Math.max(s.left, s.left + (n.w - o) * e.leftRatio)),
			s
		},
	...
	a.transitions = {
		getOrigPosition: function () {
			...
			p(n) ? (i = n.offset(), n.is("img") && (o = n.outerWidth(), r = n.outerHeight())) : (i.top = c.y + (c.h - r) * t.topRatio, i.left = c.x + (c.w - o) * t.leftRatio),
			("fixed" === a.wrap.css("position") || t.locked) && (i.top -= c.y, i.left -= c.x),
			i = {
		...
		zoomIn: function () {
			...
			e);
			delete r.position,
			o ? (e = this.getOrigPosition(), t.openOpacity && (e.opacity = .1)) : "fade" === i && (e.opacity = .1),
			a.wrap.css(e).animate(r, {
		...
		zoomOut: function () {
			...
			n && (i = this.getOrigPosition(), t.closeOpacity && (i.opacity = .1)),
			a.wrap.animate(i, {
		...
		changeIn: function () {
			...
			s = 200;
			i.opacity = .1,
			"elastic" === n && (t = "down" === r || "up" === r ? "top": "left", "down" === r || "right" === r ? (i[t] = m(g(i[t]) - s), o[t] = "+=" + s + "px") : (i[t] = m(g(i[t]) + s), o[t] = "-=" + s + "px")),
			"none" === n ? a._afterZoomIn() : a.wrap.css(i).animate(o, {
		...
		changeOut: function () {
			...
			o = a.direction,
			r = 200;
			"elastic" === e && (i["down" === o || "up" === o ? "top": "left"] = ("up" === o || "left" === o ? "-": "+") + "=" + r + "px"),
			t.wrap.animate(i, {
	...
	a.helpers.overlay = {
		...
		create: function (t) {
			...
			this.overlay = n('<div class="fancybox-overlay"></div>').appendTo(a.coming ? a.coming.parent: t.parent),
			this.fixed = !1,
		...
		close: function () {
			...
			this.el.hasClass("fancybox-lock") && (n(".fancybox-margin").removeClass("fancybox-margin"), t = r.scrollTop(), e = r.scrollLeft(), this.el.removeClass("fancybox-lock"), r.scrollTop(t).scrollLeft(e)),
		...
		update: function () {
			...
			l ? (t = Math.max(e.documentElement.offsetWidth, e.body.offsetWidth), s.width() > t && (n = s.width())) : s.width() > r.width() && (n = s.width()),
		...
		onReady: function (t, e) {
			...
			i || this.create(t),
			t.locked && this.fixed && e.fixed && (i || (this.margin = s.height() > r.height() ? n("html").css("margin-right").replace("px", "") : !1), e.locked = this.overlay.append(e.wrap), e.fixed = !1),
		...
		beforeShow: function (t, e) {
			...
			}).addClass("fancybox-margin"), this.el.addClass("fancybox-margin")), i = r.scrollTop(), o = r.scrollLeft(), this.el.addClass("fancybox-lock"), r.scrollTop(i).scrollLeft(o)),
			this.open(t)
		},
		onUpdate: function () {
		...
		beforeShow: function (t) {
			...
			if (n.isFunction(r) && (r = r.call(o.element, o)), d(r) && "" !== n.trim(r)) {
				...
				default:
					...
					a.current.margin[2] += Math.abs(g(e.css("margin-bottom")))
				}
	...
	n.fn.fancybox = function (t) {
		...
		return t = t || {},
		e = t.index || 0,
		o && t.live !== !1 ? s.undelegate(o, "click.fb-start").delegate(o + ":not('.fancybox-item, .fancybox-nav')", "click.fb-start", r) : i.unbind("click.fb-start").bind("click.fb-start", r),
	...
	s.ready(function () {
		...
		n("<style type='text/css'>.fancybox-margin{margin-right:" + (r - e) + "px;}</style>").appendTo("head")
	})
	...
	this.WOW = function () {
		...
		o.prototype.start = function () {
			...
			if (this.stopped = !1, this.boxes = function () {
				var t, n, i, o;
				for (i = this.element.querySelectorAll("." + this.config.boxClass), o = [], t = 0, n = i.length; n > t; t++) e = i[t],
				o.push(e);
				return o
			}.call(this), this.all = function () {
				var t, n, i, o;
				for (i = this.boxes, o = [], t = 0, n = i.length; n > t; t++) e = i[t],
				o.push(e);
				return o
			}.call(this), this.boxes.length) if (this.disabled()) this.resetStyle();
			else {
				for (o = this.boxes, n = 0, i = o.length; i > n; n++) e = o[n],
				this.applyStyle(e, !0);
			...
			return this.config.live ? new t(function (t) {
				return function (e) {
					var n, i, o, r, s;
					for (s = [], o = 0, r = e.length; r > o; o++) i = e[o],
					s.push(function () {
						var t, e, o, r;
						for (o = i.addedNodes || [], r = [], t = 0, e = o.length; e > t; t++) n = o[t],
		...
		o.prototype.doSync = function (t) {
			...
			if (null == t && (t = this.element), 1 === t.nodeType) {
				for (t = t.parentNode || t, o = t.querySelectorAll("." + this.config.boxClass), r = [], n = 0, i = o.length; i > n; n++) e = o[n],
		...
		o.prototype.resetStyle = function () {
			var t, e, n, i, o;
			for (i = this.boxes, o = [], e = 0, n = i.length; n > e; e++) t = i[e],
		...
		o.prototype.vendorSet = function (t, e) {
			...
			r.push(function () {
				var e, r, s, a;
				for (s = this.vendors, a = [], e = 0, r = s.length; r > e; e++) o = s[e],
				a.push(t["" + o + n.charAt(0).toUpperCase() + n.substr(1)] = i);
				return a
			}.call(this));
			return r
		},
		o.prototype.vendorCSS = function (t, e) {
			var n, o, r, s, a, l;
			for (o = i(t), n = o.getPropertyCSSValue(e), l = this.vendors, s = 0, a = l.length; a > s; s++) r = l[s],
	...
	n.prototype.slide = function (e, n) {
		...
		if (this.$element.trigger(u), !u.isDefaultPrevented()) {
			...
			return t.support.transition && this.$element.hasClass("slide") ? (o.addClass(e), o[0].offsetWidth, i.addClass(s), o.addClass(s), i.one("bsTransitionEnd", function () {
				...
				0)
			}).emulateTransitionEnd(1e3 * i.css("transition-duration").slice(0, -1))) : (i.removeClass("active"), o.addClass("active"), this.sliding = !1, this.$element.trigger(d)),
			r && this.cycle(),
			this
		}
	};
	...
	n.prototype.show = function () {
		...
		if (this.hasContent() && this.enabled) {
			...
			if (l) {
				...
				s = "bottom" == s && c.top + c.height + p - h.scroll > h.height ? "top": "top" == s && c.top - h.scroll - p < 0 ? "bottom": "right" == s && c.right + u > h.width ? "left": "left" == s && c.left - u < h.left ? "right": s,
